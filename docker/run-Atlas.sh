...
curl -X POST -H "Content-Type: application/json" --data '
  {"name": "mongo-sink",
   "config": {
     ...
     // "connection.uri":"mongodb+srv://<uid>:<passowrd>@<cluster-ip>",
     "database":"test",
...
==============================================================================================================
Examine the topics in the Kafka UI: http://localhost:9021 or http://localhost:8000/  *** Use both APIs
...
Examine the collections:
  - Use Compass to inspect collections, as these will be in the Atlas Cloud
==============================================================================================================
